# R2v3 CERTIFICATION INITIAL INTAKE FORM
...
### Facility Details (Complete for each location):
...
**Electronics Processing Activities:** (Check all that apply)  
...
**Previous R2 Certification History:**  
